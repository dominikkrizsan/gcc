...
<div class="flex flex-wrap min-h-screen w-full content-center justify-center bg-gray-200 py-10">
    ...
    <div class="flex shadow-md max-[800px]:flex-col">
      ...
      <div class="flex  flex-wrap content-center justify-center rounded-l-md bg-white" style="width: 24rem; height: 32rem;">
        <div class="w-72 ">
          <!-- Heading -->
          <h1 class="text-xl font-semibold">Join the <span class="text-purple-700 font-bold">GCC</span> community</h1>
          <small class="text-gray-400">Welcome to GCC fill out the form to sign up</small>
          ...
          <form  method="POST" action="{{ route('register') }}" class="mt-4">
            ...
            <div class="mb-3">
              <label class="mb-2 block text-xs font-semibold">Password Again</label>
            ...
            <div class="mb-3">
              <button class="mb-1.5 block w-full text-center text-white bg-purple-700 hover:bg-purple-900 px-2 py-1.5 rounded-md ease-in duration-200">Register</button>
            </div>
          </form>
  
          <!-- Footer -->
          <div class="text-center">
            <span class="text-xs text-gray-400 font-semibold">You already have account?</span>
            <a href="{{ url('login') }}" class="text-xs font-semibold text-purple-700">Sign in</a>
          </div>
        </div>
      </div>
