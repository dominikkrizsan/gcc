...
@section('main_content')
    <div class="grid grid-cols-2 mt-36 justify-items-center items-center">
        <div class="text-2xl text-white flex flex-col gap-5 items-start">
            <h1 class="text-4xl font-bold">Time to join the community</h1>
            <h1 class="text-4xl font-bold">Become the best gcc player</h1>
            ...
            <div class="flex items-center gap-4">
                ...
                <p>krizs0 and 200 others have already joined</p>  
            </div>
        </div>
