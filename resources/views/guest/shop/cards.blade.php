...
<form class="w-96 max-[550px]:w-64 mt-2 mx-auto">   
    ...
    <div class="relative">
        ...
        <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm border border-zinc-300 rounded-lg focus:ring-sky-500 focus:border-sky-500 bg-zinc-600 border-zinc-600 placeholder-zinc-400 text-white focus:ring-sky-500 focus:border-sky-500" placeholder="Search Mockups, Logos..." required>
