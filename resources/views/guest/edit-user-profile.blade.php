...
<div class="w-128 mx-auto bg-zinc-300 p-3 mt-5 rounded-xl shadow-lg">
    <p class="text-center text-2xl font-bold">Edit your Profile</p>
        <form action="{{ url('update-user-profile') }}" method="POST" enctype="multipart/form-data" class="flex flex-col w-96 mx-auto gap-2">
            @csrf
